...
function editTask() {
    ...
    document.getElementById("edit-task-body").value =
...
function deleteTask() {
    ...
    if (confirm("Êtes-vous sûr de vouloir supprimer cette tâche ?")) {
        window.location.href =
            "./gestionTask/supprimer.php?task_id=" + window.currentTaskId;
    }
}
...
function updateTaskList() {
    ...
    xhr.onload = function () {
        if (this.status == 200) {
            ...
            var taskListContainer = document.getElementById(
                "task-list-container"
            ); // L'élément contenant la liste des tâches
