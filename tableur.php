            ...
            <div class="filter-form">
                ...
                <form action="" method="get">
                    <div class="filter-group">
                        ...
                        <select class="members-input" name="sort" id="sort">
                    ...
                    <div class="filter-group">
                        ...
                        <select class="members-input" name="direction" id="direction">
                            <option value="ASC">Croissant</option>
                            <option value="DESC">Décroissant</option>
                        </select>
                    </div>
                    <div class="filter-group">
                        <button type="submit" class="btn filter-button">Confirmer</button>
                    </div>
                </form>
            </div>
